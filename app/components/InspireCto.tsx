    ...
    <div className="relative px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
      ...
      <h1 className="mb-4 text-xl font-extrabold tracking-wider leading-none text-red-500 md:text-5xl lg:text-6xl underline-offset-4 underline  z-[5] uppercase">As you Dreamed</h1>
        ...
        <div className="w-full z-1 h-full absolute !m-[0] bottom-[-0.3px] left-[0px] ">
              <a href="#" className="inline-flex justify-center z-5 items-center py-2 px-8  md:py-6 md:px-16 text-base font-medium text-center text-white  bg-red-500 hover:bg-sky-600 focus:ring-4 focus:ring-sky-300 dark:focus:ring-sky-900">
                Get Free Quote

...
const TestimonialCard: React.FC = () => {
  return (
    <div className="relative flex flex-col bg-sky-800 text-white p-8 rounded-lg md:max-w-4xl mx-auto w-full">
      <div className="hidden md:block absolute  left-24 top-16 md:top-0 md:left-0 w-32 h-32 bg-sky-600 clip-path-diagonal transform -translate-y-16 -translate-x-16"></div>
      <div className="relative flex flex-col  items-center space-x-6">
        ...
        <div className='flex flex-col p-8 items-center ml-4'>
          {/* <svg
          ...
          <strong className='text-4xl md:text-6xl'>&ldquo;</strong> 
         ...
         </p> <strong className=' text-4xl md:text-6xl md:ml-80'>&rdquo;</strong>
         
          <div className="mt-4">
            <span className="block text-xl font-semibold">Michelle Kizongo</span>
            <span className="block text-base text-blue-300 text-center">Customer</span>
          </div>
        </div>
      </div>
    </div>

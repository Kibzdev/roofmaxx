...
const TestimonialCard: React.FC = () => {
  return (
    <div className="relative bg-sky-800 text-white p-8 rounded-lg max-w-4xl mx-auto">
      <div className="absolute top-0 left-0 w-32 h-32 bg-sky-700 clip-path-diagonal transform -translate-y-16 -translate-x-16"></div>

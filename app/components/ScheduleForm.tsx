...
const ScheduleForm: React.FC<ScheduleFormProps> = ({ className }) => {
  ...
  return (
    <div className={`relative z-20 flex flex-col bg-gray-300 md:bg-red-500 p-6 md:rounded-lg shadow-md w-full md:w-1/3 md:max-w-md justify-center mt-[480px] md:mt-24 ${className}`}>
      <ToastContainer />

...
const HeroBanner: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[640px] mt-24 sm:mt-32 md:mt-40 bg-gray-50 flex flex-col-reverse md:flex-row items-center justify-center md:justify-between">

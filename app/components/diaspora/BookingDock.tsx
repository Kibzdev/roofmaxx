...
const BookingDock: React.FC<ScheduleFormProps> = ({ className }) => {
  ...
  const onSubmit = (e: FormEvent) => {
    e.preventDefault();
    console.log('Data', name, email, phone, country, serviceName, message);
  };

  return (
    <div className='fixed  bottom-8    md:bottom-0    right-0 mb-4 mr-4 h-16 md:h-24 flex justify-end items-center md:z-50'>
      <div className='flex flex-col justify-center items-center '>
        <Sheet>
          <SheetTrigger asChild>
            <button className='flex gap-2 items-center justify-center md:px-8 px-2 md:mt-4 py-2 md:py-4 md:mr-8 text-sky-800 border-2 bg-red-500 border-red-500/30 shadow-xl rounded-3xl group hover:bg-sky-800 hover:text-white'>

...
const Tailored = () => {
  return (
    <Section title="Tailored Solutions" image={{ src:contactImg, shape: 2 }}>
      <p className='text-gray-600 mb-1  text-center md:text-left font-normal  leading-6 md:text-xl text-sm py-2'>
      At Roofmax Roofing Solutions, we understand that our diaspora clients have unique tastes and requirements,
       ...
       <p className='text-gray-600 mb-1  text-center md:text-left font-normal  leading-6 md:text-xl text-sm py-2'>We are committed to delivering customized roofing solutions that reflect your personal style and preferences, 
